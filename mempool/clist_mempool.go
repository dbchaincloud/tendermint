...
import (
	...
	auto "github.com/dbchaincloud/tendermint/libs/autofile"
	"github.com/dbchaincloud/tendermint/libs/clist"
...
func (mem *CListMempool) Update(
	...
	for i, tx := range txs {
		...
		// Mempool after:
		//   100
		// https://github.com/dbchaincloud/tendermint/issues/3322.
		if e, ok := mem.txsMap.Load(txKey(tx)); ok {
