...
file](https://github.com/dbchaincloud/tendermint/blob/master/abci/types/types.proto).
...
```sh
mkdir -p \
  $KVSTORE_HOME/src/main/proto/github.com/dbchaincloud/tendermint/abci/types \
  $KVSTORE_HOME/src/main/proto/github.com/dbchaincloud/tendermint/crypto/merkle \
  $KVSTORE_HOME/src/main/proto/github.com/dbchaincloud/tendermint/libs/kv \
  $KVSTORE_HOME/src/main/proto/github.com/gogo/protobuf/gogoproto

cp $GOPATH/src/github.com/dbchaincloud/tendermint/abci/types/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/dbchaincloud/tendermint/abci/types/types.proto
cp $GOPATH/src/github.com/dbchaincloud/tendermint/crypto/merkle/merkle.proto \
   $KVSTORE_HOME/src/main/proto/github.com/dbchaincloud/tendermint/crypto/merkle/merkle.proto
cp $GOPATH/src/github.com/dbchaincloud/tendermint/libs/kv/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/dbchaincloud/tendermint/libs/kv/types.proto
...
package](https://godoc.org/github.com/dbchaincloud/tendermint/lite)) can leverage
...
Github](https://github.com/dbchaincloud/tendermint/issues/new/choose). To dig
