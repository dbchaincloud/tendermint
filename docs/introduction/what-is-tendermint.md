...
(ABCI)](https://github.com/dbchaincloud/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/dbchaincloud/tendermint) (the
...
Types](https://github.com/dbchaincloud/tendermint/blob/master/abci/README.md#message-types).
