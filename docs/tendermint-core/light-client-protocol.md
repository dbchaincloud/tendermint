...
See our [lite
package](https://pkg.go.dev/github.com/dbchaincloud/tendermint/lite2?tab=doc).
...
https://pkg.go.dev/github.com/dbchaincloud/tendermint/lite2?tab=doc#TrustOptions
