...
import (
	...
	"github.com/dbchaincloud/tendermint/libs/fail"
	...
	tmevents "github.com/dbchaincloud/tendermint/libs/events"
...
func (cs *State) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		// a typical peer.
		// https://github.com/dbchaincloud/tendermint/issues/1281
		// }
	...
	if err != nil { // nolint:staticcheck
		...
		// https://github.com/dbchaincloud/tendermint/issues/3406
...
func (cs *State) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if err == ErrVoteHeightMismatch {
			...
			// 		(https://github.com/dbchaincloud/tendermint/issues/3839).
